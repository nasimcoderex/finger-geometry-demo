...
//#endregion
//#region node_modules/onnxruntime-web/dist/ort.wasm.bundle.min.mjs
/*!
...
var ut = (n, t) => {
	for (var a in t) Jt(n, a, {
		get: t[a],
		enumerable: !0
	});
};
var Ka = (n, t, a, u) => {
	if (t && typeof t == "object" || typeof t == "function") for (let o of Qa(t)) !Za.call(n, o) && o !== a && Jt(n, o, {
		get: () => t[o],
		enumerable: !(u = Xa(t, o)) || u.enumerable
	});
	return n;
};
var Xt = (n) => Ka(Jt({}, "__esModule", { value: !0 }), n);
var ft;
var Be;
var qe;
var es;
...
var Qt = F(() => {
	...
	ft = /* @__PURE__ */ new Map(), Be = [], qe = (n, t, a) => {
		...
		if (t.aborted) return t.error;
		{
			let a = !!t.initPromise;
			try {
				return a || (t.initPromise = t.backend.init(n)), await t.initPromise, t.initialized = !0, t.backend;
			} catch (u) {
				return a || (t.error = `${u}`, t.aborted = !0), t.error;
			} finally {
		...
		set logLevel(n) {
			if (n !== void 0) {
				if (typeof n != "string" || [
					...
					"error",
					"fatal"
				].indexOf(n) === -1) throw new Error(`Unsupported logging level: ${n}`);
				wr = n;
			}
		},
		get logLevel() {
...
var Er = F(() => {
	...
	yr = (n, t) => {
		...
		if (u != null) {
			...
			l === void 0 || l.mean === void 0 ? m = [
				255,
				255,
				255,
				255
			] : typeof l.mean == "number" ? m = [
				l.mean,
				l.mean,
				l.mean,
				l.mean
				...
				l.mean[2],
				0
			], l.mean[3] !== void 0 && (m[3] = l.mean[3])), l === void 0 || l.bias === void 0 ? h = [
				0,
				0,
				0,
				0
		...
		if (a != null) {
			...
			m === void 0 || m.mean === void 0 ? h = [
				255,
				255,
				255,
				255
			] : typeof m.mean == "number" ? h = [
				m.mean,
				m.mean,
				m.mean,
				m.mean
				...
				m.mean[2],
				255
			], m.mean[3] !== void 0 && (h[3] = m.mean[3])), m === void 0 || m.bias === void 0 ? g = [
				0,
				0,
				0,
				0
			] : typeof m.bias == "number" ? g = [
				m.bias,
				m.bias,
				m.bias,
				m.bias
...
var Ir = F(() => {
	...
	Kt = (n, t) => {
		...
		let { height: a, width: u } = t, o = t.norm ?? {
			mean: 255,
			bias: 0
		}, d, c;
		typeof o.mean == "number" ? d = [
			o.mean,
			o.mean,
			o.mean,
			o.mean
		...
		let { width: a, height: u, download: o, dispose: d } = t;
		return new Q({
			location: "texture",
			type: "float32",
			texture: n,
...
var Ur = F(() => {
	...
	Pr = (n) => {
		...
		switch (n.location) {
			case "cpu": return new Q(n.type, n.data, t);
			case "cpu-pinned": return new Q({
				location: "cpu-pinned",
				data: n.data,
				type: n.type,
				dims: t
			});
			case "texture": return new Q({
				location: "texture",
				texture: n.texture,
				type: n.type,
				dims: t
			});
			case "gpu-buffer": return new Q({
				location: "gpu-buffer",
				gpuBuffer: n.gpuBuffer,
				type: n.type,
				dims: t
			});
			case "ml-tensor": return new Q({
				location: "ml-tensor",
				mlTensor: n.mlTensor,
				type: n.type,
				dims: t
			});
			default: throw new Error(`tensorReshape: tensor location ${n.location} is not supported`);
		}
	};
});
var Q;
		...
		async run(t, a, u) {
			...
			if (typeof a == "object") {
				...
				if (Array.isArray(a)) {
					...
					let h = !1, g = Object.getOwnPropertyNames(a);
					for (let b of this.outputNames) if (g.indexOf(b) !== -1) {
						let y = a[b];
						(y === null || y instanceof de) && (h = !0, c = !1, o[b] = y);
					}
					if (h) {
						if (typeof u == "object" && u !== null) d = u;
						else if (typeof u < "u") throw new TypeError("'options' must be an object.");
	...
	zr && (self.onmessage = (n) => {
		...
		try {
			switch (t) {
				...
				case "end-profiling": Et(a), postMessage({ type: t });
			}
		} catch (u) {
			postMessage({
				type: t,
...
async function Vr(n = {}) {
	...
	if (a || u) {
		...
		u && (c = (e) => {
			...
			if (k(e)) return new Promise((i, s) => {
				...
				f.open("GET", e, !0), f.responseType = "arraybuffer", f.onload = () => {
	...
	var g, b, y, T, I, D, z = console.log.bind(console), v = console.error.bind(console), O = z, N = v, _ = !1, k = (e) => e.startsWith("file://");
	function w() {
		...
		let e = function(r) {
			try {
				...
				if (s === "load") {
					...
					})(i.Ob), zt(i.Ob, 0, 0, 1, 0, 0), wn(), Nt(i.Ob), Z ||= !0;
					try {
						Ao(i.bc, i.Tb);
					} catch (f) {
						if (f != "unwind") throw f;
	...
	var j, ne, pe, B, W, re, me, A, K, je = !1;
	function ee() {
		var e = ge.buffer;
	...
	function H(e) {
		throw N(e = "Aborted(" + e + ")"), _ = !0, e = new WebAssembly.RuntimeError(e + ". Build with -sASSERTIONS for more info."), I?.(e), e;
	}
	function q() {
		return { a: {
			R: fa,
	...
	async function Ut() {
		...
		}) : o ? e(new WebAssembly.Instance(b, q()), b) : (K ??= t.locateFile ? t.locateFile ? t.locateFile("ort-wasm-simd-threaded.wasm", h) : h + "ort-wasm-simd-threaded.wasm" : new URL("../../onnxruntime-web/dist/ort-wasm-simd-threaded.wasm", import.meta.url).href, r = await (async function(s) {
			var f = K;
			if (!g && !k(f)) try {
	...
	var bn = (e) => new Promise((r) => {
		e.onmessage = (f) => {
			...
			if (f = p.Pb, p.Sb && p.Sb != st()) {
				...
				hn(Oe[p.cc]);
			}) : f === "loaded" ? (e.loaded = !0, r(e)) : p.target === "setimmediate" ? e.postMessage(p) : f === "uncaughtException" ? e.onerror(p.error) : f === "callHandler" ? t[p.Yb](...p.args) : f && N(`worker sent an unknown command ${f}`);
		}, e.onerror = (f) => {
	...
	function Io(e) {
		var r = new xt(e >>>= 0);
		return (w(), j)[r.Qb + 12 >>> 0] == 0 && (En(r, !0), nt--), Tn(r, !1), tt.push(r), fr(e);
	}
	var Fe = 0, Bo = () => {
		C(0, 0);
		var e = tt.pop();
	...
	var Do = () => {
		...
		var r = e.Ub;
		throw (w(), j)[e.Qb + 13 >>> 0] == 0 && (tt.push(e), Tn(e, !0), En(e, !1), nt++), Vt(r), Fe = r;
	};
	function Uo(e, r, i) {
		var s = new xt(e >>>= 0);
	...
	function vn(e, r, i, s) {
		...
		var f = [];
		return o && f.length === 0 ? Sn(e, r, i, s) : (e = {
			ac: i,
			Ob: e,
			Tb: s,
			Xb: f
		}, o ? (e.Pb = "spawnThread", postMessage(e, f), 0) : ue(e));
	}
	function Co(e) {
		throw Fe ||= e >>> 0, Fe;
	}
	...
	function Fo(e, r) {
		(e >>>= 0) == r >>> 0 ? setTimeout(rt) : o ? postMessage({
			Sb: e,
			Pb: "checkMailbox"
		}) : (e = Oe[e]) && e.postMessage({ Pb: "checkMailbox" });
	}
	var Ft = [];
	function ko(e, r, i, s, f) {
		for (r >>>= 0, f >>>= 0, Ft.length = 0, i = f >>> 3, s = f + s >>> 3; i < s;) {
			var p = (w(), A)[i++ >>> 0] ? (w(), A)[i++ >>> 0] : (w(), me)[i++ >>> 0];
			Ft.push(p);
		}
	...
	function Ho(e, r) {
		e = -9007199254740992 > e || 9007199254740992 < e ? NaN : Number(e), r >>>= 0, e = /* @__PURE__ */ new Date(1e3 * e), (w(), B)[r >>> 2 >>> 0] = e.getSeconds(), (w(), B)[r + 4 >>> 2 >>> 0] = e.getMinutes(), (w(), B)[r + 8 >>> 2 >>> 0] = e.getHours(), (w(), B)[r + 12 >>> 2 >>> 0] = e.getDate(), (w(), B)[r + 16 >>> 2 >>> 0] = e.getMonth(), (w(), B)[r + 20 >>> 2 >>> 0] = e.getFullYear() - 1900, (w(), B)[r + 24 >>> 2 >>> 0] = e.getDay();
...
`))[0] == "Error" && s.shift(), jn(s);
	...
	o || (function() {
	...
	})(), o || (ge = new WebAssembly.Memory({
		initial: 256,
		maximum: 65536,
		shared: !0
	}), ee()), t.wasmBinary && (g = t.wasmBinary), t.stackSave = () => U(), t.stackRestore = (e) => P(e), t.stackAlloc = (e) => jt(e), t.setValue = function(e, r, i = "i8") {
		switch (i.endsWith("*") && (i = "*"), i) {
			...
			case "*":
				(w(), W)[e >>> 2 >>> 0] = r;
				break;
			default: H(`invalid type for setValue: ${i}`);
		}
	}, t.getValue = function(e, r = "i8") {
		switch (r.endsWith("*") && (r = "*"), r) {
			case "i1":
			case "i8": return (w(), j)[e >>> 0];
			case "i16": return (w(), pe)[e >>> 1 >>> 0];
			case "i32": return (w(), B)[e >>> 2 >>> 0];
			case "i64": return (w(), A)[e >>> 3 >>> 0];
			case "float": return (w(), re)[e >>> 2 >>> 0];
			case "double": return (w(), me)[e >>> 3 >>> 0];
			case "*": return (w(), W)[e >>> 2 >>> 0];
			default: H(`invalid type for getValue: ${r}`);
		}
	}, t.UTF8ToString = Mt, t.stringToUTF8 = Ae, t.lengthBytesUTF8 = Wt;
	var st, Kn, er, zt, tr, nr, rr, Ht, or, ar, C, Je, sr, P, jt, U, ir, Vt, ur, fr, cr, Ee, ua = [
		V,
		fe,
		Sn,
		In,
	...
	function it() {
		if (0 < Re) te = it;
			...
			0 < Re ? te = it : (t.calledRun = !0, _ || (he(), T?.(t)));
		}
	}
...
var pt = F(() => {
	...
	Qr = typeof location > "u" ? void 0 : location.origin, an = import.meta.url > "file:" && import.meta.url < "file;", as = () => {
		if (an) return new URL(new URL("ort.wasm.bundle.min.mjs", import.meta.url).href, Qr).href;
...
var xe = F(() => {
	...
	un = !1, St = !1, no = !1, fs = () => {
		...
		let o = n.wasmPaths, d = typeof o == "string" ? o : void 0, c = o?.mjs, l = c?.href ?? c, m = o?.wasm, h = m?.href ?? m, g = n.wasmBinary, [b, y] = await to(l, d, a > 1, !!g || !!h), T = !1, I = [];
		if (t > 0 && I.push(new Promise((D) => {
			...
			y(v).then((O) => {
				St = !1, un = !0, sn = O, D(), b && URL.revokeObjectURL(b);
			}, (O) => {
				St = !1, no = !0, z(O);
			});
...
var oo = F(() => {
	...
	ro = (n) => {
		...
		try {
			...
			n?.terminate === void 0 && (o.terminate = !1);
			let d = 0;
...
var so = F(() => {
	...
	ds = (n) => {
		switch (n) {
			...
			case "all": return 99;
			default: throw new Error(`unsupported graph optimization level: ${n}`);
		}
	}, ps = (n) => {
		switch (n) {
			case "sequential": return 0;
			case "parallel": return 1;
			default: throw new Error(`unsupported execution mode: ${n}`);
		}
	}, ms = (n) => {
		n.extra || (n.extra = {}), n.extra.session || (n.extra.session = {});
		let t = n.extra.session;
		t.use_ort_model_bytes_directly || (t.use_ort_model_bytes_directly = "1"), n.executionProviders && n.executionProviders.some((a) => (typeof a == "string" ? a : a.name) === "webgpu") && (n.enableMemPattern = !1);
	}, ke = (n, t, a, u) => {
		...
		for (let o of u) {
			...
			switch (d) {
				...
				case "wasm":
				case "cpu": continue;
				default: throw new Error(`not supported execution provider: ${d}`);
			}
...
var fn = F(() => {
	...
	We = (n) => {
		switch (n) {
			...
			default: throw new Error(`unsupported data type: ${n}`);
		}
	}, Ot = (n) => {
		switch (n) {
			case 3: return "int8";
		...
		let a = [
			...
			.5,
			.5
		][n], u = typeof t == "number" ? t : t.reduce((o, d) => o * d, 1);
		...
		switch (n) {
			...
			default: throw new Error(`unsupported type: ${n}`);
		}
	}, uo = (n) => {
		switch (n) {
			...
			case "error": return 3;
			case "fatal": return 4;
			default: throw new Error(`unsupported logging level: ${n}`);
		}
		...
		switch (n) {
			...
			default: throw new Error(`unsupported data location: ${n}`);
		}
	};
});
var Ke;
	...
	ws = (n, t) => {
		...
		if (t === "webgpu") {
			...
			if (a) {
				...
				if (a = await navigator.gpu.requestAdapter({
					powerPreference: u,
					forceFallbackAdapter: o
				}), !a) throw new Error("Failed to get GPU adapter. You may need to enable flag \"--enable-unsafe-webgpu\" if you are using Chrome.");
			}
		}
		...
		try {
			...
			for (let _ of t?.executionProviders ?? []) if ((typeof _ == "string" ? _ : _.name) === "webnn") {
				if (o.shouldTransferToMLTensor = !1, typeof _ != "string") {
					let w = _, Z = w?.context, j = w?.gpuDevice, ne = w?.deviceType, pe = w?.powerPreference;
					Z ? o.currentContext = Z : j ? o.currentContext = await o.webnnCreateMLContext(j) : o.currentContext = await o.webnnCreateMLContext({
						deviceType: ne,
						powerPreference: pe
					});
			...
			d = await o._OrtCreateSession(a, u, c), o.webgpuOnCreateSession?.(d), d === 0 && G("Can't create a session."), o.jsepOnCreateSession?.(), o.currentContext && (o.webnnRegisterMLContext(d, o.currentContext), o.currentContext = void 0, o.shouldTransferToMLTensor = !0);
			let [b, y] = bs(d), T = !!t?.enableGraphCapture, I = [], D = [], z = [], v = [];
			for (let _ = 0; _ < b; _++) {
				let [k, w, Z] = co(d, _);
			...
			throw h.forEach((y) => o._OrtFree(y)), g.forEach((y) => o._OrtFree(y)), d !== 0 && o._OrtReleaseSession(d) !== 0 && G("Can't release session."), b;
		} finally {
		...
		let h = m[0], g = m[1], b = m[2], y = m[3], T = m[4];
		m[5];
		let D = t.length, z = u.length, v = 0, O = [], N = [], _ = [], k = [], w = [], Z = c.stackSave(), j = c.stackAlloc(D * l), ne = c.stackAlloc(D * l), pe = c.stackAlloc(z * l), B = c.stackAlloc(z * l);
		try {
			...
			for (let A = 0; A < z; A++) {
				...
				let je = c.stackSave(), ee = c.stackAlloc(4 * l), he = !1, H, q = 0;
				try {
					...
					if (H === "string") {
						...
						he = !0, re.push([
							...
							{
								gpuBuffer: V,
								download: c.jsepCreateDownloader(V, fe, H),
								dispose: () => {
						...
						if (!V(n, H, !1)) throw new Error(`preferredLocation "ml-tensor" for ${H} output is not supported by current WebNN Context.`);
						let ye = await L(n, q, ve, te, !1);
						he = !0, re.push([
							H,
							te,
							{
								mlTensor: ye,
								download: c.webnnCreateMLTensorDownloader(q, H),
								dispose: () => {
						...
						let V = new (io(H))(ue);
						new Uint8Array(V.buffer, V.byteOffset, V.byteLength).set(c.HEAPU8.subarray(q, q + V.byteLength)), re.push([
							H,
							te,
							V,
							"cpu"
			...
			y && !T && (c._OrtClearBoundOutputs(y.handle) !== 0 && G("Can't clear bound outputs."), $e.set(n, [
				h,
				g,
				b,
				y,
...
var pn = F(() => {
	...
	xe();
	pt();
	Me = () => !!Y.wasm.proxy && typeof document < "u", et = !1, Lt = !1, _t = !1, dn = /* @__PURE__ */ new Map(), ze = (n, t) => {
		let a = dn.get(n);
		...
		switch (n.data.type) {
			case "init-wasm":
				et = !1, n.data.err ? (_t = !0, ln[1](n.data.err)) : (Lt = !0, ln[0]()), Bt && (URL.revokeObjectURL(Bt), Bt = void 0);
				break;
			case "init-ep":
			case "copy-from":
			case "create":
		...
		if (!Lt) {
			...
			if (et = !0, Me()) return new Promise((n, t) => {
				ie?.terminate(), eo().then(([a, u]) => {
					try {
						...
						!o.in.wasm.wasmPaths && (a || an) && (o.in.wasm.wasmPaths = { wasm: new URL("../../onnxruntime-web/dist/ort-wasm-simd-threaded.wasm", import.meta.url).href }), ie.postMessage(o), Bt = a;
					} catch (o) {
						t(o);
					}
				}, t);
			...
			try {
				await mt(Y.wasm), await ht(Y), Lt = !0;
			} catch (n) {
				throw _t = !0, n;
			} finally {
				et = !1;
...
var To = F(() => {
	...
	Eo = (n, t) => {
		switch (n.location) {
			...
			default: throw new Error(`invalid data location: ${n.location} for ${t()}`);
		}
	}, Es = (n) => {
		switch (n[3]) {
			case "cpu": return new de(n[0], n[2], n[1]);
			case "gpu-buffer": {
				let t = n[0];
				if (!At(t)) throw new Error(`not supported data type: ${t} for deserializing GPU tensor`);
				let { gpuBuffer: a, download: u, dispose: o } = n[2];
				return de.fromGpuBuffer(a, {
					dataType: t,
					dims: n[1],
					download: u,
					dispose: o
			...
			default: throw new Error(`invalid data location: ${n[3]}`);
		}
	}, Pt = class {
...
var vo = {};
ut(vo, {
	OnnxruntimeWebAssemblyBackend: () => Dt,
	initializeFlags: () => So,
	wasmBackend: () => Ts
});
var So;
...
var Oo = F(() => {
	...
	So = () => {
		...
		let n = Y.wasm.simd;
		if (typeof n != "boolean" && n !== void 0 && n !== "fixed" && n !== "relaxed" && (console.warn(`Property "env.wasm.simd" is set to unknown value "${n}". Reset it to \`false\` and ignore SIMD feature checking.`), Y.wasm.simd = !1), typeof Y.wasm.proxy != "boolean" && (Y.wasm.proxy = !1), typeof Y.wasm.trace != "boolean" && (Y.wasm.trace = !1), typeof Y.wasm.numThreads != "number" || !Number.isInteger(Y.wasm.numThreads) || Y.wasm.numThreads <= 0) if (typeof self < "u" && !self.crossOriginIsolated) Y.wasm.numThreads = 1;
		else {
...
Object.defineProperty(Y.versions, "web", {
	value: Gr,
	enumerable: !0
});
//#endregion
export { ts as InferenceSession, xr as TRACE, De as TRACE_EVENT_BEGIN, Ue as TRACE_EVENT_END, _e as TRACE_FUNC_BEGIN, Pe as TRACE_FUNC_END, de as Tensor, au as default, Y as env, qe as registerBackend };
